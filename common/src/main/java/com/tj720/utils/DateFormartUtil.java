...
public class DateFormartUtil {
	 ...
	 * 将时间戳转换为时间  年月日时分秒
	 */
	public static String stampToDate(Date dateDate){
	 ...
	 * 将时间戳转换为时间  年月日时分
	 */
	public static String stampToDateDevelop(Date dateDate){
		String  dateString = null;
     ...
     * 将时间戳转换为时间  年月日
     */
    public static String stampToDateSimple(Date dateDate){
		String  dateString = null;
	...
	/**
	 * 将String格式转为date格式   年月日
	 */
	public static Date string2DateSimple(String dateStr) throws ParseException{
