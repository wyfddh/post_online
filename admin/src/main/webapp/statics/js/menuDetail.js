...
var main={
    ...
    initTable:function(){
        var cyProps = "url:'"+property.getProjectPath()+"Function/queryFunctionListTree.do',name:'parentid'";
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(data){
                ...
                var url = "Function/addFunction.do";
                if (pageType == "edit"){
...
function loadData(id) {
    ...
    layui.use('form', function(){
        ...
        $.ajax({
            ...
            data:json,
            async:false,
            url:property.getProjectPath()+"Function/queryFunctionById.do",
            success:function(result) {
                if (result.success == 1) {
